...
class AdminController extends Controller
{
    ...
    public function update($id,Request $request){
        ...
        $user->save();
        return  redirect('admin/admin/list')->with('success','El Usuario '.$user->username.' fue actualizado');
    }
    public function delete($id){
        $user=User::getSingle($id);
        $user->is_delete=1;
        $user->save();
        return redirect('admin/admin/list')->with('success','Administrador Eliminado'); 
    }    
